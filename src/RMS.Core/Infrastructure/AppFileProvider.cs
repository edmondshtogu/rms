...
{
    /// <inheritdoc cref="IAppFileProvider" />
    /// <summary>
    ...
    public class AppFileProvider : PhysicalFileProvider, IAppFileProvider
    {
        ...
        public AppFileProvider(string rootPath)
            : base(rootPath)
        {
        ...
        private static void DeleteDirectoryRecursive(string path)
        {
            ...
            // https://stackoverflow.com/questions/4216396/system-io-directorynotfoundexception-after-deleting-an-empty-folder-and-recreati/4245121#4245121
